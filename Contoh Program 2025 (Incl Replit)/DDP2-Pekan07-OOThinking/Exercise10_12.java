...
public class Exercise10_12 {
  public static void main(String[] args) {
    Triangle2D r1 = new Triangle2D(3.5, 3, 5.2, 4, 6, 4.5);
    System.out.println("Area is " + r1.getArea());
    System.out.println("Perimeter is " + r1.getPerimeter());
    System.out.println(r1.contains(4, 4));
    System.out.println(r1.contains(new Triangle2D(3.9, 3, 5, 2, 2, 4.4)));
    System.out.println(r1.overlaps(new Triangle2D(3, 6.5, 5, -2, 3, 7.5)));
  }
}

class Triangle2D {
  // MyPoint is defined in Exercise10_04
